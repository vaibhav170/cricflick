 ...
 <body style="background: linear-gradient(to top left, #ffcc66 27%, #ff66cc 100%); font-family:monospace;color:white">
   <nav class="navbar navbar-inverse">
     <div class="container-fluid">
       ...
       <ul style="padding-left:45%" class="nav navbar-nav">
...
echo "<h1 style=\"font-family: 'Roboto', sans-serif;\">". $tn . " ( ". $tr . " )    &nbsp vs  &nbsp   ";
...
if($so1r[0]['start1']==-1)
{
  ...
  echo "<br><br><span id='sm1'>select two player for batting <br><br>";
  $sbt1r=$sbt1->fetchAll();
    echo "select first batsman on strike <br><div style='margin-left:40%;margin-right:40%;text-align:center'><select class=\"form-control\" name='sb1' id='sb1' ><option value='0'  >select one...";
...
echo "</select><br><br>select second non striker <br><select class=\"form-control\" name='sb2' id='sb2'><option value='0' >select one...</option>";
foreach ($sbt1r as $pid) {
    $key1=$pid['pid'];
...
echo "</select><br><br>select bowler <br><Select class=\"form-control\" id='sbl1'><option value='0'>select one...</option>";
...
echo "</div><br></select><br><br><input type='button' class=\"btn btn-info\" value='add players' onclick='addd2()'><br></span>";
