  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul  class="nav navbar-nav navbar-right">
        ...
        <li class='active'><a >insert team</a></li>
  ...
  <div class="page-wrapper bg- p-t-100 p-b-100 font-robo" style='padding-top:50px'>
      <div class="wrapper wrapper--w680">
          <div class="card card-1">
              ...
              <div class="card-body" >
  <form action="crteam.php">
    <div class="row row-space" style="width:100%; text-align:center;">
      <h2 style="width:100%;">Create New Team</h2>
    </div>
    <br>
    <br>
    <div >
    ...
    <input type="text" class="input--style-1" style="width:100%; text-align:center;" placeholder="Enter New Team ID" name="ftid">
  </div>
  </div>
  </div>
    <br>
    ...
    <div class="row row-space" style="width:100%; padding-left:25%;padding-right:25%;">
        <div class="input-group" style="width:100%; text-align:center;">
          <input class="input--style-1" style="width:100%; text-align:center;" placeholder="Enter New Team Name" type="text" name="ftname">
        </div>
        </div>
        </div>
          <br>
          ...
          <div class="row row-space" style="width:100%; padding-left:25%;padding-right:25%;">
              <div class="input-group" style="width:100%; text-align:center;">
<input type="text" name="fcname" class="input--style-1" style="width:100%; text-align:center;" placeholder="Representing">
...
<div class="row row-space" style="width:100%; padding-left:25%;padding-right:25%;">
    <div class="input-group" style="width:100%; text-align:center;">
<input type="text" name="sname" class="input--style-1" style="width:100%; text-align:center;" placeholder="Enter Team Short Name">
...
$_SESSION['loginerror']="Need to sign in for insertion of TEAMS";
...
<div class="p-t-20" style="margin-left:25%;margin-right:25%;">
    ...
    <input class="btn btn--radius btn--green" value="create team" type=submit>
  </div>
